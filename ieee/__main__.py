...
def main():
    ...
    arg_parser.add_argument('-n', required=True,
                            metavar='grammar_name', help='ANTLR4 grammar name')
    arg_parser.add_argument('-s', type=int, metavar='start_page',
                            help='formal syntax start page (default: first page)')
    arg_parser.add_argument('-e', type=int, metavar='end_page',
                            help='formal syntax end page (default: last page)')
    arg_parser.add_argument('--split', action='store_true',
                            help='create a split grammar')
