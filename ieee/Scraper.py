...
class Scraper(bnfParserVisitor):
	...
	def getLexerRules(self):
		char_names = { '0':'ZERO', '1':'ONE', '2':'TWO', '3':'THREE', '4':'FOUR', '5':'FIVE', '6':'SIX', '7':'SEVEN', '8':'EIGHT', '9':'NINE', '!':'EM', '"':'DQ', '#':'HA', '$':'DL', '%':'MO', '&':'AM', '\\':'BS', '\'':'AP', '(':'LP', ')':'RP', '*':'AS', '+':'PL', ',':'CO', '-':'MI', '.':'DT', '/':'SL', ':':'CL', ';':'SC', '<':'LT', '=':'EQ', '>':'GT', '?':'QM', '@':'AT', '[':'LB', ']':'RB', '^':'CA', '`':'GA', '{':'LC', '|':'VL', '}':'RC', '~':'TI' }
		text = ''
