...
Converts `Formal Syntax` section of an IEEE language standard document to an [ANTLR4](https://www.antlr.org/) grammar
...
```bash
usage: scrape-ieee [-h] -n grammar_name [-s start_page] [-e end_page] input_file
...
- Manually fix the highlighted issues (and remove trailing title text, e.g. 'A.10'..., in some rules)
